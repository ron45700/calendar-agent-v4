...
class OnboardingStates(StatesGroup):
    ...
    Flow: Confirmation → Nickname → Agent Name → Gender → Reminder Mode → Daily Briefing → Colors → Contacts → Complete
    """
    ...
    # Step 4: Reminder Mode toggle (new — replaces legacy reminders + daily check)
    WAITING_FOR_REMINDER_MODE = State()

    # Step 5: Daily briefing toggle
